...
;(function ($) {
    ...
    $.fn.InputSpinner = $.fn.inputSpinner = function (options) {
        ...
        var html = '<div class="input-group ' + config.groupClass + '">' +
            ...
            '</div>' +
            '<input type="text" inputmode="numeric" style="text-align: ' + config.textAlign + '" class="form-control ' + config.inputClass + '"' + (config.disabledInput ? " disabled" : "") + '/>' +
        ...
        this.each(function () {
            ...
            function stepHandling(step) {
                if (config.disabledInput || (!$input[0].disabled && !$input[0].readOnly)) {
                    calcStep(step)
                    resetTimer()
            ...
            function updateAttributes() {
                ...
                var disabled = config.disabledInput || $original.prop("disabled")
